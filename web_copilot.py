...
if not args.query:
    ...
    # args.query = "Goto HKTV mall website in 'https://www.hktvmall.com/hktv/en/', search for 'rice' products, then add the first product to cart. Then go to the checkout page."
