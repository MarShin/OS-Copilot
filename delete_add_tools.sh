...
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name pick_one_product_1
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name pick_one_product_2
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name pick_one_product_3_2
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name pick_one_product_3
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name pick_one_product_4
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name pick_one_product_5
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name pick_one_product
python oscopilot/tool_repository/manager/tool_manager.py --delete --tool_name goto_cart_url
...
python oscopilot/tool_repository/manager/tool_manager.py --add --tool_name goto_cart_url --tool_path agent_simulation/tools_to_add/goto_cart_url.py